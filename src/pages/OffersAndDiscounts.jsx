...
const offersData = [
  { id: "EID-26", name: "خصم العيد", value: "20%", expiry: "15 مايو 2026", status: "نشط" },
  { id: "SUMMER", name: "عرض الصيف", value: "15%", expiry: "1 سبتمبر 2026", status: "نشط" },
  { id: "NEW50", name: "خصم العملاء الجدد", value: "50 ر.س", expiry: "غير محدد", status: "نشط" },
  { id: "RAMADAN", name: "عروض رمضان", value: "30%", expiry: "10 أبريل 2026", status: "منتهي" },
  { id: "VIP10", name: "خصم كبار الشخصيات", value: "10%", expiry: "31 ديسمبر 2026", status: "نشط" },
];
...
export default function OffersAndDiscounts() {
    ...
    const categories = ["الكل", "خصومات مئوية", "مبالغ ثابتة", "عروض خاصة"];
   ...
   <div className="dashboard-panel">
      <div className="dashboard-wrapper">
        <div className="sidebar">
          ...
          <MenuItem icon={<Gift size={18} />} text="العروض والخصومات" to="/offers" active/>
        ...
        <div className="main-content">
          ...
          <h1 className="main-title">العروض والخصومات</h1>

          <div className="stats-grid">
            <Card title="العروض النشطة" value="4" icon={<CheckCircle2 />} color="text-green-500" />
            <Card title="عروض منتهية" value="1" icon={<AlertTriangle />} color="text-orange-400" />
            <Card title="مرات الاستخدام" value="342" icon={<Gift />} color="text-purple-400" />
            <Card title="كوبونات ترحيب" value="15" icon={<Gift />} color="text-[#4A7FA7]" />
          </div>
 ...
 */}
                        ...
                        <div className="search-container">
                            ...
                            <input type="text" placeholder="بحث عن عرض أو كود..." className="search-input" 
                            value={search}
                    ...
                    >
                      ...
                      <span>إضافة عرض وخصومات جديدة</span>
                    </button>
                        </div>
                      </div>
                ...
                <div className="orders-table-container">
                    <div className="grid grid-cols-6 gap-4 px-6 pb-4 text-[11px] font-bold text-[#9CA3AF] uppercase border-b border-[#F9FAFB] mb-4 w-full">
                        <div className="text-right">كود الخصم</div>
                        <div className="text-right">اسم العرض</div>
                        <div className="text-center">القيمة</div>
                        <div className="text-center">تاريخ الانتهاء</div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div key={o.id} className="grid grid-cols-6 gap-4 items-center p-5 bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F3F4F6] hover:bg-[#F8FAFC] transition-colors w-full">
                            <div className="flex flex-col text-right">
                                <span className="font-bold text-[#4A7FA7] text-[13px]">{o.id}</span>
                            </div>
                            <div className="flex flex-col text-right">
                                <span className="font-bold text-[#4B5563] text-[13px]">{o.name}</span>
                            </div>
                            <div className="flex flex-col text-center">
                                <span className="text-[#6B7280] text-[14px] font-black">{o.value}</span>
                            </div>
                            <div className="flex flex-col text-center">
                                <span className="text-[#9CA3AF] text-[12px] font-semibold">{o.expiry}</span>
                            </div>
                            <div className="flex justify-center">
                                <div className={`px-4 py-1.5 rounded-xl text-[10px] font-black text-center min-w-[80px] ${
                                    o.status === "نشط" ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"
                                }`}>
                                    {o.status}
                                </div>
                            </div>
                            <div className="flex justify-end items-center gap-3">
                                <button className="bg-[#4A7FA7] text-white px-5 py-2 rounded-xl text-[10px] font-bold hover:bg-[#3A6F97] transition-colors shadow-sm flex items-center gap-2"
                                    onClick={() => {
                                        setSelectedOffer(o); // تمرير البيانات
                                        setShowOfferModal(true);
                                      }}
                                    >                                    <Edit size={14} /> تعديل
                                </button>
          ...
          <div className="bg-white w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl relative">
            ...
            <div className="flex flex-col gap-4">
              ...
              <input
                ...
                defaultValue={selectedOffer?.expiry || ""}
                className="bg-gray-50 border border-gray-100 rounded-xl p-3 text-sm outline-none"
              />
            </div>
            ...
            <button className="w-full mt-6 bg-[#4A7FA7] text-white py-3 rounded-2xl font-bold text-sm">
              {selectedOffer ? "حفظ التعديلات" : "إضافة العرض"}
            </button>
          </div>
        </div>
      )}
